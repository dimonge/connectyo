	...
	$(document).ready(function() {
		...
		$('.infinite-carousel').on( 'position-slides', function() {
			...
			var slides = new Array(
				cycleSelection( currentSlideIndex, -3, $slides ),
			...
			for (var i = 0; i < slides.length; i++ ) {
				...
				if ( i-3 == 3 && $infiniteCarousel.data('carousel-direction') == 'next' ) {
					...
					//Re-enable animation
					slides[i]
						.data('slide-position', ( $viewport.width() * .5 ) - ( slideWidth * .5 )  + (slideWidth * ( i-3 ) ) )
						.trigger('slide-transition')
						.addClass('slide-enable-animation')
						.data( 'slide-index', i-3 )
